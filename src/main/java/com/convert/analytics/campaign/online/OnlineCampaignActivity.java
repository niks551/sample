 ...
 * 
 */
public class OnlineCampaignActivity {
    ...
    private Map<String, C2EActivity> engagementActivities;
     ...
     */
    public OnlineCampaignActivity(String mKey, String cKey, long start, long end,
            Map<String, C2EActivity> engagementActivities) {
    ...
    public long getTotalTreatmentImpressinos() {
        return getTotalImpressions(false);
    }

    public long getTotalControlImpressinos() {
        return getTotalImpressions(true);
    }

    public long getTotalImpressions() {
        return getTotalControlImpressinos() + getTotalTreatmentImpressinos();
    }

    public long getTotalImpressions(boolean isControl) {
        long sum = 0;
        for (C2EActivity c2ea : this.engagementActivities.values()) {
    ...
    public long[][] getGoals() {
        ...
        for (Entry<String, C2EActivity> entry : engagementActivities.entrySet()) {
    ...
    public Map<String, C2EActivity> getEngagementActivities() {
        return engagementActivities;
    }

    public C2EActivity getEngagementActivity(String eKey, boolean isControl) {
        return engagementActivities.get(eKey + "_" + (isControl ? '1' : '0'));
    }

    public List<C2EActivity> getControlEngagementActivities() {
        return getEngagementActivities(true);
    }

    public List<C2EActivity> getTreatmentEngagementActivities() {
        return getEngagementActivities(false);
    }

    public List<C2EActivity> getEngagementActivities(boolean isControl) {
        final List<C2EActivity> controlActivities = new ArrayList<C2EActivity>(engagementActivities.size());
        for (C2EActivity c2eActivity : engagementActivities.values()) {
